				...
				addBehaviour(new Behaviour() {
					...
					private void doWaitInPlace(String placeEnvouy) {
						try {
							...
							switch (NomV) {
							case "Voiture1":{
								  MyContanarevoitures.chrono.Name=("Voiture1 sur la "+placeEnvouy+" ");
								...
								break; }
							case "Voiture2":{
								  MyContanarevoitures.chrono2.Name=("Voiture2 sur la "+placeEnvouy+" ");
							...
							case "Voiture3":{
								  MyContanarevoitures.chrono3.Name=("Voiture3 sur la "+placeEnvouy+" ");
							...
							case "Voiture4":{
								  MyContanarevoitures.chrono4.Name=("Voiture sur la "+placeEnvouy+" ");
								...
								break;
								  ...
								  MyContanarevoitures.chrono5.Name=("Voiture5 sur la "+placeEnvouy+" ");
							...
							case "Voiture6":{
								  MyContanarevoitures.chrono6.Name=("Voiture6 sur la "+placeEnvouy+" ");
							...
							case "Voiture7":{
								  MyContanarevoitures.chrono7.Name=("Voiture7 sur la "+placeEnvouy+" ");
							...
							case "Voiture8":{					
								MyContanarevoitures.chrono8.Name=("Voiture8 sur la "+placeEnvouy+" ");
							...
							case "Voiture9":{						
								MyContanarevoitures.chrono9.Name=("Voiture9 sur la "+placeEnvouy+" ");
								...
								MyContanarevoitures.chrono10.Name=("Voiture10 sur la "+placeEnvouy+" ");
